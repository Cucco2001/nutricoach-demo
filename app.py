...
def build_prompt():
    prompt = (
        ...
        "Utilizza i valori nutrizionali delle tabelle ufficiali USDA e CREA per stimare le calorie. Utilizzare anche linee guida CREA per una dieta sana\n\n"
    ...
    prompt += (
        ...
        "- Se cliente va in palestra, mettere spuntino pre e post allenamento. Pre con piu carbs, post con piu proteine"
        "- Bilancia ciascun pasto secondo direttive LARN, mai superare 40 gr di proteine in un pasto e bilanciare bene pasti"
        "- Includi una sostituzione per ogni alimento proposto che contenga circa gli stessi macronutrienti\n"
        "- Includi quantità in grammi (e numero cucchiai o cucchiaini ove possibile), kcal giornaliere, % di macronutrienti\n"
        "- Almeno 3 pranzi e 3 cene diversi nella settimana\n"
        "- Ingredienti comuni e facili da reperire\n"
        "- Una spiegazione finale sul ragionamento utilizzato in base a LARN e dati paziente\n"
