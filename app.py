...
def build_prompt():
    ...
    prompt += (
        ...
        "- Una spiegazione finale sul ragionamento utilizzato in base a LARN e dati paziente, includendo spiegazione del perchè quel quantitativo di calorie e quella distribuzione di macronutrienti\n"
