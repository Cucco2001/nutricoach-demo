...
class PreferencesUI:
    ...
    def display_preferences_interface(self, user_id: str):
        ...
        with col1:
            st.markdown('<div class="preferences-card">', unsafe_allow_html=True)
    ...
    def _display_add_food_form(self, food_type: str):
        ...
        """
        label = "Inserisci alimento (1 alla volta)" if food_type == "excluded" else "Inserisci alimento (1 alla volta)"
